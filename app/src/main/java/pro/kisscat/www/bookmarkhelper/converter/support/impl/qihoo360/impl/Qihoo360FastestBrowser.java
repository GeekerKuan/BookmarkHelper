...
public class Qihoo360FastestBrowser extends Qihoo360BrowserAble {
    private static final String packageName = "com.qihoo.chrome360";
    private List<Bookmark> bookmarks;

    public Qihoo360FastestBrowser() {
        super.TAG = "360Fastest";
    }
    ...
    public void fillDefaultIcon(Context context) {
        this.setIcon(ContextCompat.getDrawable(context, R.drawable.ic_360_fastest));
    }

    @Override
    public void fillDefaultAppName(Context context) {
        this.setName(context.getString(R.string.browser_name_show_360_fastest));
    }

    private static final String filePath_origin = Path.INNER_PATH_DATA + packageName + Path.FILE_SPLIT;
    private static final String filePath_cp = Path.SDCARD_ROOTPATH + Path.SDCARD_APP_ROOTPATH + Path.SDCARD_TMP_ROOTPATH + Path.FILE_SPLIT + "360Fastest" + Path.FILE_SPLIT;
