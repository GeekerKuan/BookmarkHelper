...
public class OupengBrowser extends BasicBrowser {
    ...
    public void fillDefaultAppName(Context context) {
        this.setName(context.getString(R.string.browser_name_show_oupeng));
    }
    ...
    private static final String filePath_cp = Path.SDCARD_ROOTPATH + Path.SDCARD_APP_ROOTPATH + Path.SDCARD_TMP_ROOTPATH + Path.FILE_SPLIT + "Oupeng" + Path.FILE_SPLIT;
    ...
    private List<OupengBookmark> parseBookmark(Cursor cursor) {
        ...
        while (cursor.moveToNext()) {
            ...
            item.setIsfolder(cursor.getInt(cursor.getColumnIndexOrThrow("isfolder")));
