...
public class XWithMaskBrowser extends XBrowserAble {
    private static final String packageName = "com.mmbox.browser";
    private List<Bookmark> bookmarks;


    public XWithMaskBrowser() {
        super.TAG = "XWithMask";
    }
    ...
    public void fillDefaultIcon(Context context) {
        this.setIcon(ContextCompat.getDrawable(context, R.drawable.ic_x_mask));
    }

    @Override
    public void fillDefaultAppName(Context context) {
        this.setName(context.getString(R.string.browser_name_show_x_mask));
    }

    private static final String filePath_origin = Path.INNER_PATH_DATA + packageName + Path.FILE_SPLIT + "databases" + Path.FILE_SPLIT;
    private static final String filePath_cp = Path.SDCARD_ROOTPATH + Path.SDCARD_APP_ROOTPATH + Path.SDCARD_TMP_ROOTPATH + Path.FILE_SPLIT + "XWithMask" + Path.FILE_SPLIT;
