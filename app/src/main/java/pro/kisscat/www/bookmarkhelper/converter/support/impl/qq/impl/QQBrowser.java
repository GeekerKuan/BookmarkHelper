...
public class QQBrowser extends QQBrowserAble {
    ...
    private static final String filePath_cp = Path.SDCARD_ROOTPATH + Path.SDCARD_APP_ROOTPATH + Path.SDCARD_TMP_ROOTPATH + Path.FILE_SPLIT + "QQ" + Path.FILE_SPLIT;
