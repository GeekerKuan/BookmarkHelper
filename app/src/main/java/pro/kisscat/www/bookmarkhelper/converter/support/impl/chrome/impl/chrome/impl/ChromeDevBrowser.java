...
public class ChromeDevBrowser extends ChromeBrowserAble {
    private static final String TAG = "ChromeDev";
    private static final String packageName = "com.chrome.dev";
    ...
    public void fillDefaultIcon(Context context) {
        this.setIcon(ContextCompat.getDrawable(context, R.drawable.ic_chrome_dev));
    }

    @Override
    public void fillDefaultAppName(Context context) {
        this.setName(context.getString(R.string.browser_name_show_chrome_dev));
    }
