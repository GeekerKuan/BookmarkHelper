...
public class ChromeCanaryBrowser extends ChromeBrowserAble {
    private static final String TAG = "ChromeCanary";
    private static final String packageName = "com.chrome.canary";
    ...
    public void fillDefaultIcon(Context context) {
        this.setIcon(ContextCompat.getDrawable(context, R.drawable.ic_chrome_canary));
    }

    @Override
    public void fillDefaultAppName(Context context) {
        this.setName(context.getString(R.string.browser_name_show_chrome_canary));
    }
    ...
    private static final String filePath_cp = Path.SDCARD_ROOTPATH + Path.SDCARD_APP_ROOTPATH + Path.SDCARD_TMP_ROOTPATH + Path.FILE_SPLIT + "ChromeCanary" + Path.FILE_SPLIT;
